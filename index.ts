...
import { addCars, getCars, getCarskById ,deleteCars , updateCars} from "./app/controller/car-controller";
import { login, register, whoAmI} from "./app/controller/user-controllers";
...
app.get("/api/v1/me",authorize , whoAmI )
